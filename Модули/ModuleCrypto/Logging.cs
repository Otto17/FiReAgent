    ...
    internal class Logging
    {
        ...
        internal static void WriteToLogFile(string message)
        {
            try
            {
                ...
                string logFilePath = Path.Combine(PATH_LOG, "log_ModuleCrypto.txt");
        ...
        private static void RotateLogFiles()
        {
            try
            {
                ...
                string oldestLogFile = Path.Combine(PATH_LOG, $"log_ModuleCrypto_{MAX_LOG_FILES - 1}.txt");
                ...
                {
                    string oldFile = Path.Combine(PATH_LOG, $"log_ModuleCrypto_{i - 1}.txt");
                    string newFile = Path.Combine(PATH_LOG, $"log_ModuleCrypto_{i}.txt");
                ...
                string currentLogFile = Path.Combine(PATH_LOG, "log_ModuleCrypto.txt");
                string newLogFile = Path.Combine(PATH_LOG, "log_ModuleCrypto_0.txt");
